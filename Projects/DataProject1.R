  ...
  sidebarLayout(
    ...
    mainPanel(
      tabsetPanel(
        ...
        tabPanel("Additional Visualizations", plotOutput("pieChart"), plotOutput("barPlot"), plotOutput("cityPlot"), plotOutput("boxplot")),
...
# - The most spending frequence is whole milk it repeated 3 times at confidence =0.06 and support =0.05
# - The number of rules = 6 at confidence = 0.06 and support = 0.05
